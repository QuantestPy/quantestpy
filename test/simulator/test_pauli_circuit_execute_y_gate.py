...
class TestPauliCircuitExecuteYgate(unittest.TestCase):
    """
    How to execute this test:
    $ pwd
    {Your directory where you git-cloned quantestpy}/quantestpy
    $ python -m unittest test.simulator.test_pauli_circuit_execute_y_gate
    ....
    ----------------------------------------------------------------------
    ...
    def test_qubit_value_after_y_operation_on_0(self,):
        circ = PauliCircuit(100)
        target_qubit = random.sample(range(0, 100), k=20)
        circ._execute_y_gate(target_qubit)
    ...
    def test_qubit_value_after_y_operation_on_1(self,):
        circ = PauliCircuit(100)
    ...
    def test_qubit_phase_after_y_operation_on_0(self,):
        circ = PauliCircuit(100)
    ...
    def test_qubit_phase_after_y_operation_on_1(self,):
        circ = PauliCircuit(100)
        circ._qubit_value = np.array([1]*100)
        target_qubit = random.sample(range(0, 100), k=60)
        circ._execute_y_gate(target_qubit)
